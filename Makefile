...
minimal-dependencies-amd64:
	$(DOCKER_BUILD) \
		--platform linux/amd64 \
		-t landinjm/pagoma-dependencies:alpine-minimal-amd64 \
...
minimal-dependencies-arm64:
	$(DOCKER_BUILD) \
		--platform linux/arm64 \
		-t landinjm/pagoma-dependencies:alpine-minimal-arm64 \
		--build-arg NJOBS=${NJOBS} \
		--build-arg ALL_DEPENDENCIES=OFF \
		./dependencies

minimal-dependencies-merge::
	docker buildx imagetools create -t landinjm/pagoma-dependencies:alpine-minimal \
		landinjm/pagoma-dependencies:alpine-minimal-arm64 \
		landinjm/pagoma-dependencies:alpine-minimal-amd64
